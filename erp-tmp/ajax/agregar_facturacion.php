	...
	?>
		<tr>
			...
			<td class='col-xs-1'>
				...
				<input type="text" class="form-control numbers" style="text-align:right" id="cantidad_tmp_<?php echo $id_tmp; ?>" value="<?php echo $cantidad;?>"  pattern="\d{1,4}" required >
			</div></td>
			
			<td><?php echo $nombre_producto;?></td>
			<td class='col-xs-3' ><div class="pull-left">
				<textarea class="form-control" id="dato_adicional_<?php echo $id_tmp; ?>" cols="60" rows="3"  ><?php echo $dato_adicional;?></textarea>
			</div></td>
			
			<!-- <td class='text-right'><?php echo $precio_venta_f;?></td> -->
			<td class='col-xs-2'>
				<div class="pull-right">
				<input type="text" class="form-control numbers" style="text-align:right" id="precio_tmp_<?php echo $id_tmp; ?>" value="<?php echo $precio_venta_f;?>" required pattern="^[0-9]+(\.[0-9]{1,2})?$" >
			</div></td>

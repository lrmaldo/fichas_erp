			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td ><?php echo $ficha_1hra; ?> <a class="btn <?php echo $button_color1;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',1, <?php echo $ficha_1hra; ?> )"> Imprimir </a>  </td>
						<td ><?php echo $ficha_2hra; ?> <a class="btn <?php echo $button_color2;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',2, <?php echo $ficha_2hra; ?> )"> Imprimir </a>  </td>
						<td ><?php echo $ficha_3hra; ?> <a class="btn <?php echo $button_color3;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',3, <?php echo $ficha_3hra; ?> )"> Imprimir </a> </td>
						<td ><?php echo $ficha_4hra; ?> <a class="btn <?php echo $button_color4;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',4, <?php echo $ficha_4hra; ?> )"> Imprimir </a> </td>
						<td ><?php echo $ficha_5hra; ?> <a class="btn <?php echo $button_color5;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',5, <?php echo $ficha_5hra; ?> )"> Imprimir </a> </td>
						<td ><?php echo $ficha_6hra; ?> <a class="btn <?php echo $button_color6;?>" href="#" onclick="print_cards('<?php echo $user_id; ?>',6, <?php echo $ficha_6hra; ?>)"> Imprimir </a> </td>

	...
	$cerrada=$row['cerrada'];
		...
		<tr>
			...
			<td class='col-xs-1'>
				...
				<input type="text" class="form-control numbers" style="text-align:right" id="cantidad_update_<?php echo $id_detalle; ?>" value="<?php echo $cantidad;?>" pattern="\d{1,4}" 
			...
			<td class='col-xs-3' ><div class="pull-left">
				<textarea <?php if ($cerrada==1){echo "disabled";}?> class="form-control" id="dato_adic_update_<?php echo $id_detalle; ?>" cols="60" rows="3"  ><?php echo $dato_adicional;?>
				</textarea>
			</div></td>
			
			<td class='col-xs-2'>
				<div class="pull-right">
				<input type="text" class="form-control numbers" style="text-align:right" id="precio_update_<?php echo $id_detalle; ?>" value="<?php echo $precio_venta_f;?>" required pattern="^[0-9]+(\.[0-9]{1,2})?$" 
					<?php if ($cerrada==1){echo "disabled";}?> required >
			</div></td>

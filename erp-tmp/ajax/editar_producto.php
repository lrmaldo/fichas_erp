	...
	if (empty($_POST['mod_id'])) {
		...
		if ($img_stat==1) {
			...
			$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', status_producto='".$estado.
				...
				"',stock_min='".$stock_min."',invent_ini='".$invent_ini."' WHERE id_producto='".$id_producto."'";
			//$answwer="S";
		} else {
			...
			"',precio_cost='".$precio_cost."',stock_min='".$stock_min."',invent_ini='".$invent_ini."' WHERE id_producto='".$id_producto."'";
			//$answwer="N";
		}

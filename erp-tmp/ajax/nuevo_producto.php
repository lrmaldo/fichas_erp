<?php
	...
	if (empty($_POST['codigo'])) {
		...
		if ($img_stat==1) {
			...
			prod_invent, precio_cost, precio2, precio3, precio4, stock_min, invent_ini) VALUES ('$codigo','$nombre',
			...
			utili4, prod_invent, precio_cost, precio2, precio3, precio4, stock_min, invent_ini) VALUES 
			...
			'$precio3','$precio4','$stock_min','$invent_ini' )";
		}

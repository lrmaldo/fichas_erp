...
CREATE TABLE `compras` (
  ...
  `cargo_envio_fact` DECIMAL(15,2) DEFAULT '0', 
  `cargo_externo_flete` DECIMAL(15,2) DEFAULT '0', 
  `numero_factura` INT(11) NOT NULL DEFAULT '0', 
  `fecha_factura` DATETIME, 
  `desc1` INT(5) DEFAULT '0', 
  `desc2` INT(5) DEFAULT '0', 
  `cond_pago_dias` INT(5) DEFAULT '0', 
  `pie_subtotal` DECIMAL(15,2) DEFAULT '0', 
  `pie_desc` DECIMAL(15,2) DEFAULT '0', 
  `pie_total` DECIMAL(15,2) DEFAULT '0', 
  `pie_cargo_flete` DECIMAL(15,2) DEFAULT '0', 
  `pie_iva` DECIMAL(15,2) DEFAULT '0', 
  `pie_importe_total` DECIMAL(15,2) DEFAULT '0', 
  `pie_cant_prod` DECIMAL(15,3) DEFAULT '0', 
...
DROP TABLE IF EXISTS `DETA_COMPRAS`;
CREATE TABLE `deta_compras` (
  `id_deta_compra` INT(11) NOT NULL DEFAULT 0, 
  `numero_factura` INT(11) NOT NULL DEFAULT 0, 
  `id_producto` INT(11) NOT NULL DEFAULT 0, 
  `cantidad` DECIMAL(15,3) NOT NULL, 
  `precio_costo` DECIMAL(15,3) NOT NULL DEFAULT 0, 
  `obser_partida` CHAR(100), 

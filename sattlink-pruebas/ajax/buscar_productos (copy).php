			  ...
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						title="<?php echo $utili1."% U";?>" > <?php echo $simbolo_moneda;?> <span class='pull-right'><?php echo $precio_producto;?></span> </a></td>
						
						<td><a href="#" data-toggle="tooltip" data-placement="top" 
						title="<?php echo $utili2."% U";?>" > <?php echo $simbolo_moneda;?> <span class='pull-right'><?php echo $precio2;?></span> </a></td>
						
						<td><a href="#" data-toggle="tooltip" data-placement="top" 
						title="<?php echo $utili3."% U";?>" > <?php echo $simbolo_moneda;?> <span class='pull-right'><?php echo $precio3;?></span> </a></td>
						
						<td><a href="#" data-toggle="tooltip" data-placement="top" 
						title="<?php echo $utili4."% U";?>" > <?php echo $simbolo_moneda;?> <span class='pull-right'><?php echo $precio4;?></span> </a></td>
						
						<td><span class='pull-right'><?php echo number_format($existencia,3);?></span></td>

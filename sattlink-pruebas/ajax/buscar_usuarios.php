			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$pasw_mail=$row['pasw_mail'];
						$mail_alterno=$row['mail_alterno'];
				    ...
				    <input type="hidden" value="<?php echo $pasw_mail;?>" id="pasw_mail<?php echo $user_id;?>">
				  	<input type="hidden" value="<?php echo $mail_alterno;?>" id="mail_alterno<?php echo $user_id;?>">
				    <input type="hidden" value="<?php echo $type_user;?>" id="type_user<?php echo $user_id;?>">

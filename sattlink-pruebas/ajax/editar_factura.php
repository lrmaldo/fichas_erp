<?php
	...
	/*Inicia validacion del lado del servidor*/
		...
		$dire_clie_fora = (isset( $_POST['direcc'] ))?$_POST['direcc']:'';
		$col_clie_fora = (isset( $_POST['colonia'] ))?$_POST['colonia']:'';
		$ciu_clie_fora = (isset( $_POST['ciudad'] ))?$_POST['ciudad']:'';
		$rfc_clie_fora = (isset( $_POST['rfc'] ))?$_POST['rfc']:'';
		//End customer foraneo
		
		//Add empresaslc 25Jul2019
		$opt_empresaslc=$_POST['opt_empresaslc'];
		
		//Add opt_coments 20Sep2019
		$opt_coments=$_POST['opt_coments'];
		$id_theme_image=$_POST['id_theme_image'];
		...
		if($cpr > 9) {
			...
			"', col_cliente_foraneo='".$col_clie_fora."', ciudad_cliente_foraneo='".$ciu_clie_fora."', rfc_cliente_foraneo='" . 
			$rfc_clie_fora . "', membresias_selections='" . $item_membre . "',id_theme_coment=". $opt_coments . 
			", id_theme_image=". $id_theme_image . ", empresaslc=" . $opt_empresaslc . " WHERE id_factura='".$id_factura."'";
			$flag="> 9";
		} else if($cpr==2) {
			...
			$sql="UPDATE facturas SET estado_factura='".$estado_factura."',tel_cliente_foraneo='".$tel1.
				...
				"',id_theme_coment=". $opt_coments . ",	id_theme_image=". $id_theme_image . 
				", empresaslc=" . $opt_empresaslc . " WHERE id_factura='".$id_factura."'";
			$flag="8,9";
		} else if($cpr==5 or $cpr==6 ) {	// Clientes registrados
			$sql="UPDATE facturas SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', 
			condiciones='".$condiciones."', estado_factura='".$estado_factura."', membresias_selections='" . $item_membre . 
			"',id_theme_coment=". $opt_coments . ",	id_theme_image=". $id_theme_image . ", empresaslc=" . $opt_empresaslc . 
			" WHERE id_factura='".$id_factura."'";
			$flag="5,6";
		} else if($cpr==3 or $cpr==4 ) {	// Clientes foraneos
			$sql="UPDATE facturas SET estado_factura='".$estado_factura."', membresias_selections='" . $item_membre . 
			"',id_theme_coment=". $opt_coments . ",	id_theme_image=". $id_theme_image . ", empresaslc=" . $opt_empresaslc . 
			" WHERE id_factura='".$id_factura."'";
			$flag="3,4";
		}

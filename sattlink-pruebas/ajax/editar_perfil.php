<?php
	...
	if (empty($_POST['nombre_empresa'])) {
		...
		//Tab-Clientes
		$num_cli_foran=$_POST["num_cli_foran"];
		
		//Tab-Smtp
		$activate_smtp=$_POST["activate_smtp"];
		$type_encript=$_POST["type_encript"];
		$host_mail=mysqli_real_escape_string($con,(strip_tags($_POST["host_mail"],ENT_QUOTES)));
		...
		"', codigo_postal='$codigo_postal', numeracion_cliente_foraneo='".$num_cli_foran."', activate_smtp='".$activate_smtp.
		"', type_encript='".$type_encript."', host_mail='".$host_mail."', host_port='".$host_port."', subject='".$subject.
		"', body='".$body."' WHERE id_perfil='1'";

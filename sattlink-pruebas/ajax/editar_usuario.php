          ...
          )
         {
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $user_email = mysqli_real_escape_string($con,(strip_tags($_POST["user_email2"],ENT_QUOTES)));
			 	$pasw_mail = $_POST['pasw_mail'];
			 	$mail_alterno = $_POST['edit_mail_alt'];
			 	$type_user = $_POST['mod_type_user'];
			 
				$user_id=intval($_POST['mod_id']);
               
				// write new user's data into database
                $sql = "UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', user_name='".$user_name."', user_email='".$user_email. "', pasw_mail='".$pasw_mail. "', type_user='".$type_user."',mail_alterno='".$mail_alterno."' WHERE user_id='".$user_id."';";

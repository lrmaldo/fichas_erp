    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
				...
				$paswr_email2 = $_POST['paswr_email2'];
				$mail_alterno = $_POST['mail_alterno'];
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO users (firstname, lastname, user_name, user_password_hash, user_email, pasw_mail, date_added, type_user, mail_alterno) 
                            VALUES('".$firstname."','".$lastname."','" . $user_name . "', '" . $user_password_hash . "', '" . $user_email . 
						    "', '" . $paswr_email2 . "','" . $date_added . "','" . $type_user . "','". $mail_alterno . "');";

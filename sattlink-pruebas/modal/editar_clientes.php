		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
				...
				<div class="form-group">
					<label for="desc_porcent" class="col-sm-3 control-label">Desc(%) sobre el precio:</label>
					<div class="col-sm-8" >
						<input type="text" class="form-control" id="mod_desc_porc" name="mod_desc_porc" pattern="\d+(\.\d{3})?" title="Ingresa sólo números">
					</div>
				</div>

<?php
	...
	$opt_empresaslc=$data['opt_empresaslc'];	//Empresa selector
	
	$id_coments=$data['id_coments'];	//id theme coment select
	$id_theme_img=$data['id_theme_img'];	//id theme image select

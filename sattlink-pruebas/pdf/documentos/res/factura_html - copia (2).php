...
<?php
	...
	//$insert_factura = mysqli_query($con,"INSERT INTO facturas VALUES (default, '$numero_factura', '$date_added', '$id_cliente', '$id_vendedor', '$condiciones', '$total_factura', '1', '$tipo_doc', '$cerrada', '$datoc1', '$datoc2', '$datoc3', '$datoc4', '$datoc5', '$datoc6', '$datoc7', '$datoc8', '$opt_empresaslc' )");
	$insert_factura = mysqli_query($con,"INSERT INTO facturas VALUES (default, '$numero_factura', '$date_added', '$id_cliente', '$id_vendedor', '$condiciones', '$total_factura', '1', '$tipo_doc', '$cerrada', '$datoc1', '$datoc2', '$datoc3', '$datoc4', '$datoc5', '$datoc6', '$datoc7', '$datoc8', '$opt_empresaslc', '$id_coments', '$id_theme_img' )");

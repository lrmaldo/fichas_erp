...
$subtotde=0;$acum_desc_porc_ope=0;$sum_part=0;$subtotal=0;$acum_iva=0;
...
while ($row=mysqli_fetch_array($sql)) {
	...
	$insert_detail = mysqli_query($con, "INSERT INTO detalle_factura VALUES (default, '$numero_factura', '$id_producto',
	'$cantidad', '$precio_venta_r', '$dato_adicional', '$tax_iva', '$desc_porc_ope' )");
	if ($insert_detail) {
...
<?php
	...
	$insert_factura = mysqli_query($con,"INSERT INTO facturas VALUES (default, '$numero_factura', '$date_added', 
	'$id_cliente', '$id_vendedor', '$condiciones', '$total_factura', '1', '$tipo_doc', '$cerrada', '$datoc1', 
	'$datoc2', '$datoc3', '$datoc4', '$datoc5', '$datoc6', '$datoc7', '$datoc8', '$opt_empresaslc', '$id_coments', '$id_theme_img' )");
